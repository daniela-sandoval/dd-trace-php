...
class ElasticSearchIntegrationTest extends IntegrationTestCase
{
    ...
    {
        ElasticSearchSandboxedIntegration::traceNamespaceMethod('\Wrong\Namespace', 'wrong_method');
        $this->addToAssertionCount(1);
    }

    public function testMethodNotExistsDoesNotCrashApps()
    {
        ElasticSearchSandboxedIntegration::traceSimpleMethod('\Wrong\Class', 'wrong_method');
        $this->addToAssertionCount(1);
    }
